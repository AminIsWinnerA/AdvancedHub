...
local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/AminIsWinnerA/AdvancedHub/main/MainLibrary"))();main = lib:Window();
MainW = main:Tab('Literally FNF')
MainW:Toggle('Autoplay Toggle',function(state)
